...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">User Konsultasi</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <button type="button" data-url="{{ url('admin/account-consultation/create') }}" data-size="lg" class="btn btn-primary modal_add"> <i class="fa fa-plus"></i> @lang('main.button.add') </button>
            <br><br>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#myTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ url("admin/account-consultation") }}',
            columns: [{
                    data: 'DT_RowIndex',
                    orderable: false,
                    searchable: false
