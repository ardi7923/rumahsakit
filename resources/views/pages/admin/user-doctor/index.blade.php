...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">User Dokter</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <button type="button" data-url="{{ url('admin/user-doctor/create') }}" data-size="lg" class="btn btn-primary modal_add"> <i class="fa fa-plus"></i> @lang('main.button.add') </button>
            <br><br>
